    ...
    <div class="bg-bg-primary text-text-primary p-6">
        ...
        <div class="flex flex-col justify-center items-center my-20">
            <div class="flex flex-col items-center justify-center">
                ...
                <img src="../../assets/images/TNTCover.png" alt="Terror Nightmare Towers Image" class="w-1/3 h-1/5">
                <!-- <Carousel /> -->
                ...
                <NuxtLink to="/projects/tnt" class="text-bg-primary bg-text-primary font-outfit font-bold border rounded-md p-2 w-fit mt-5 mb-16 hover:bg-accent-primary hover:border-accent-primary">Projekt ansehen</NuxtLink>
            </div>
            <div class="flex flex-col items-center justify-center">
                <div class="text-text-primary font-outfit text-3xl mb-5">VP-Tracker</div>
                <img src="../../assets/images/StudentPageCropped.png" alt="Terror Nightmare Towers Image" class="w-1/3 h-1/5">
                <!-- <Carousel /> -->
                ...
                <NuxtLink to="/projects/vptracker" class="text-bg-primary bg-text-primary font-outfit font-bold border rounded-md p-2 w-fit mt-5 hover:bg-accent-primary hover:border-accent-primary">Projekt ansehen</NuxtLink>
            </div>
            <BackToTheTop />
        </div>
    </div>
