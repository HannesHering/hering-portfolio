    ...
    <div class="bg-bg-primary text-text-primary p-6">
        ...
        <div class="flex flex-col justify-center items-center my-20">
            <div class="flex flex-col items-center justify-center">
                ...
                <NuxtLink to="/projects/tnt" class="text-bg-primary bg-text-primary font-outfit font-bold border rounded-md p-2 w-fit mt-5 mb-16 hover:bg-accent-primary hover:border-accent-primary transition-all duration-300">Projekt ansehen</NuxtLink>
            </div>
            <div class="flex flex-col items-center justify-center">
